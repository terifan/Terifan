...
//					{
//						tb1 = new TextBox()
//							.setText("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur vitae lacus placerat nulla aliquam porttitor ut vel elit. Sed nisi felis, tincidunt a luctus at, porttitor sed massa. Ut ut justo dolor. Integer non justo augue, a tristique nunc. Cras in placerat est. Aliquam varius, sapien sit amet semper tristique, enim libero volutpat eros, non scelerisque enim eros sed mi. Suspendisse in pretium augue. Aenean ornare, magna ac hendrerit suscipit, enim purus luctus lectus, ut feugiat justo tellus gravida arcu. Vivamus ultricies facilisis purus eget eleifend. Vivamus sapien magna, posuere nec sollicitudin id, dapibus eget quam. Nullam lorem eros, ultrices a lobortis vel, interdum ut nunc. Vestibulum varius, nibh et pulvinar euismod, enim orci tincidunt ligula, id lobortis sem nisi vel ante.")
...
//							.setTextBorder(BorderFactory.createDashedBorder(Color.GREEN))
//							.setBounds(300,300,180,200)
//							.setLineSpacing(3)
//							.setLineCountLimit(5)
//							.pack();
//
//						tb2 = tb1.clone().setLineCountLimit(4);
//						tb3 = tb1.clone().setLineCountLimit(3);
//					}
//
//					Dimension b = tb1.getBounds().getSize();
//
//					tb1.setAnchor(Anchor.SOUTH_EAST).render(g, -b.width, -b.height);
//					tb2.setAnchor(Anchor.SOUTH).render(g, 0, -b.height);
//					tb3.setAnchor(Anchor.SOUTH_WEST).render(g, b.width, -b.height);
//
//					tb1.setAnchor(Anchor.EAST).render(g, -b.width, 0);
//					tb2.setAnchor(Anchor.CENTER).render(g);
//					tb3.setAnchor(Anchor.WEST).render(g, b.width, 0);
//
//					tb1.setAnchor(Anchor.NORTH_EAST).render(g, -b.width, b.height);
//					tb2.setAnchor(Anchor.NORTH).render(g, 0, b.height);
//					tb3.setAnchor(Anchor.NORTH_WEST).render(g, b.width, b.height);
//				}
//			};
//
