 ...
 * column if there isn't enough space vertically. VerticalFlowLayout can optionally anchor components to the top or bottom
...
//Constructors
	...
	/**
	 * Constructs an instance of VerticalFlowLayout with a vertical vgap of 5 pixels, horizontal centering and anchored to
	...
	/**
	 * Constructs a VerticalFlowLayout instance with horizontal centering, anchored to the top with the specified vgap
	 *
	...
	/**
	 * Constructs a VerticalFlowLayout instance anchored to the top with the specified vgap and horizontal alignment
	 *
	 * @param vgap An int value indicating the vertical seperation of the components
	...
	/**
	 * Constructs a VerticalFlowLayout instance with the specified vgap, horizontal alignment and anchoring
	 *
	 * @param vgap An int value indicating the vertical seperation of the components
	 * @param alignment An int value which is one of <code>RIGHT, LEFT, CENTER, BOTH</code> for the horizontal alignment.
