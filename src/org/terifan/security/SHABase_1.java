 ...
 */
public abstract class SHABase_1 extends MessageDigest implements Cloneable
{
    ...
    protected SHABase_1(String aAlgorithm)
    {
    	super(aAlgorithm);
     ...
     */
    protected SHABase_1(String aAlgorithm, SHABase_1 aBase)
    {
    	super(aAlgorithm);
