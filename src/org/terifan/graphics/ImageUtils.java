...
public class ImageUtils
{
	...
	{
		return resize(aImage, aWidth, aHeight, RenderingHints.VALUE_INTERPOLATION_BILINEAR);
	}
	 ...
	 */
	public static BufferedImage resize(BufferedImage aImage, int aWidth, int aHeight, Object aInterpolationMode)
	{
	 ...
	 */
	public static BufferedImage resizeAspect(BufferedImage aImage, int aWidth, int aHeight, Object aInterpolationMode, int aType)
	{
		if (aImage == null)
		{
	 ...
	 * @see java.awt.image.BufferedImage#TYPE_USHORT_555_RGB
	 */
	public static BufferedImage resize(BufferedImage aImage, int aWidth, int aHeight, Object aInterpolationMode, int aType)
	{
		...
		if (aWidth > aImage.getWidth() || aHeight > aImage.getHeight())
		{
			...
			g.setRenderingHint(RenderingHints.KEY_INTERPOLATION, aInterpolationMode);
	...
	private static BufferedImage resizeDown(BufferedImage aImage, int aTargetWidth, int aTargetHeight, Object aInterpolationMode, int aType)
	{
	...
	public static byte[] encodeJPEG(BufferedImage aImage, float quality)
	{
		try
		{
			...
			writer.write(null, new IIOImage(aImage, null, null), iwp);
			writer.dispose();
